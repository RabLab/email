<?php namespace RabLab\Email\Classes;

/**
 * Contact Markdown tag processor.
 *
...
class TagProcessor
{
    ...
    /**
     * Registers a callback function that handles blog template markup.
     ...
     * the function should return a markup for the blog template preview form or for the
     * front-end.
